...
def stationary_cube(xyz, whl):
    ...
    return cube, tops, bots, sides1, sides2, sides3, sides4
...
#find cube points
cube1, top, bot, side1, side2, side3, side4 = stationary_cube(box_xyz, box_whl)
cube2, top2, bot2, side12, side22, side32, side42 = stationary_cube(cube_xyz, cube_whl)
